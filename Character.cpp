...
void Character::initializeAction() {
	if (this->name.length() > 0) {
		if (name.compare("Donzo2")) {
			...
			Action normal("No-rmalAttack", "AttackL1", 0.2f, 240.0f);
			normal.setLength(85 - 50);
			char normal_str[100];
